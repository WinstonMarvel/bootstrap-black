...
<article id="post-<?php the_ID(); ?>" <?php post_class(''); ?>>
	...
	<div class="row">
		<div class="entry-content-thumbnail col-sm-3 col-xs-12 img-responsive">
		
				<?php the_post_thumbnail('medium'); ?>
			</div>
		<div class="entry-summary col-sm-9 col-xs-12 fb-hider">
			<?php the_excerpt(); ?>
		</div><!-- .entry-summary -->
	</div>	
	<?php else : ?>
	<div class="entry-content row ">
		...
		<div class="col-sm-9 col-xs-12 fb-hider">
		<?php the_content( __( '<br><span class="read-more-text">READ MORE</span><br>', '_tk' ) ); ?>
		<?php
			wp_link_pages( array(
